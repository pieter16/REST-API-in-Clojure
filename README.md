...
get the app created:
    ...
    $ heroku apps:create vallen-api
    Creating vallen... done, stack is cedar
    http://vallen.herokuapp.com/ | git@heroku.com:vallen.git
...
You can deploy the skeleton project immediately:
    ...
    [...]
    -----> Launching... done, v3
           http://vallen.herokuapp.com deployed to Heroku

    To git@heroku.com:vallen.git
     * [new branch]      master -> master

It's live! Hit it with `curl`:

    $ curl http://vallen-api.herokuap.com
    ["Hello" :from Heroku]
